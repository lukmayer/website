...
This method is NOT appropriate to use for enterprise applications, or critically sensitive information. The main reason for this is that you have no way of telling *who* is accessing pages. It should also be noted that the admin of the server that the site is hosted on can see the hashed URLs, it's not a good idea to use this method for anything that could get you into trouble. 
:::
\
