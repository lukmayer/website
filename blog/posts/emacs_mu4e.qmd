...
Setting up email in Emacs is definitely one of the more laborious things one can do.
...
I had various stabs at cracking this over the course of multiple weeks, and while I have something that works, it's a bit of a mess in my opinion, as I had to piece things together from different packages, blog posts, and forum discussions that I came across over those harsh days.
...
https://github.com/mozilla/releases-comm-central/blob/master/mailnews/base/src/OAuth2Providers.sys.mjs#L180
