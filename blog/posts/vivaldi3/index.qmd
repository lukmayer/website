...
Vivaldi, like Firefox, supports modifications, meaning you can inject your own CSS and JavaScript into the browser to change its behavior. This is very powerful as it allows you to change almost anything about the front-end of the browser. 
...
So how to go about it? Basically you just start browsing the forums for code that sounds interesting, then paste that code into a CSS file in a folder you point Vivaldi to. The full instructions on how to do this can be found [here](https://forum.vivaldi.net/topic/10549/modding-vivaldi).
...
I'm so glad I can finally use panels again without having to manually hide UI elements every time I open one. Hurray!
