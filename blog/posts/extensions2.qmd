...
[^1]: "Vimium" (without the C) is definitely the OG Vim browser extension, but I prefer Vimium C because it has sligtly better looks, and slightly more features that I find useful. Vimium C is open-source.
