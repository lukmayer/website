...
::: text-center
![By default, the Vivaldi browser has a lot of UI](assets/default_vivaldi.png){fig-cap="Credit: https://www.omgubuntu.co.uk/2022/10/vivaldi-5-5-adds-tasks-feature"}
:::

To this:

::: text-center
![Lukas Mayer has a very minimal configuration of Vivaldi that does not compromise on functionality](assets/vivaldi.png){fig-cap="My Vivaldi"}
:::
