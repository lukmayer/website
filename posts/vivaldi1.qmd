---
title: "Vivaldi: the ultimate productivity browser"
description: "You're probably not using the best browser - how sad! :("
author: "Luke"
date: "08/02/2024"
categories:
  - software
...
Now because Vivaldi is such a beast, Vivaldi can seem a little intimidating when you fire it up for the first time. So today I want to highlight the specific features of Vivaldi that allow you to go from this:


![Default Vivaldi - [Credit](https://www.omgubuntu.co.uk/2022/10/vivaldi-5-5-adds-tasks-feature)](assets/default_vivaldi.png){fig-cap="Credit: https://www.omgubuntu.co.uk/2022/10/vivaldi-5-5-adds-tasks-feature"}


To this:


![My Vivaldi](assets/vivaldi.png){fig-cap="My Vivaldi"}
...
And that's basically the essence of my workflow! If you are not (yet) a Vivaldi user, this was probably too much information for you.. if you are a Vivaldi user, I hope you found this inspiring!
