...
But what about giving users the opportunity to spend gems on, you know, obvious stuff? You don't need to be some kind of Game-design genius to realize that people may find it interesting to spend gems on customizing their profile or character, or on social features. Why is it I get badges for completing monthly challenges that noone else can see? Why are the profile statistics so limited? Why is the character I created not visible anywhere in the app outside of my profile? I really don't see why things like this, which are often what drives people to buy subscriptions in other apps, are seemingly not being developed at all? I am hopeful though that the company will come to this with time, as the introduction of the character creator is a fairly recent, and very welcome addition that clearly goes in this direction.

\

## The ugly...

In this section, I hope to describe some concerning trends I have observed as a long-time user, hopefully without sounding too much like a grumpy old man. 
...
All these changes very much feel like they were made to boost the attractiveness of their paid subscriptions, since you get access to other activities making the new extra monotonous design less of a pain, and can conveniently turn off that highly scientific feature that totally boosts learning. You don't understand why a certain answer you gave was wrong? Why see what other people say for free when you could fork over 14$ a month for the privilege of asking the AI? By the way, what did Duolingo do when their forums were regularly full of people complaining about yet another extremely unpopular change? Remove the entire forum! You really can't make this stuff up... 

With the way things are going I have to say I can't wait to learn how to order a <html>CorporateCola&trade;</html> at <html>BigBurger&reg;</html> in Spanish as a Tier 6 ultra-max-premium user! ;)
