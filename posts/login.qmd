...
description: "Personalize/Paywall content on static websites"
author: "Luke"
date: "08/15/2024"
categories:
  - webdev
...
Alternatively, visit [lukmayer.github.io/login_portal](lukmayer.github.io/login_portal) to directly go to the login portal.
...
This ensures that the rendered file sit in the folder that is named after the password hash.
...
The method I'm going to show you here can't stop a determined hacker, but it will stop whoever you're sharing this with from accidentally leaking the URLs.
...
So, for example, the index page has this script embedded, and so does this page.

What this does is override the URL shown in the address bar once the page loaded, thus hiding the hashes.
