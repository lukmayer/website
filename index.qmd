...
{{< animate fadeIn "In my research, I leverage insights from Cognitive Science to enhance human-AI collaboration." duration=3s >}}
{{< animate fadeIn "I'm particularly interested in the application of model-based reinforcement learning, Bayesian computational models, and causal reasoning." duration=3s >}}
