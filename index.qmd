...
Hi, I'm Luke! I'm currently a PhD Student in Cognitive Science in [Mark Steyvers' lab](https://steyvers.socsci.uci.edu/madlab/) at the University of California, Irvine.
:::

{{< animate fadeIn "In my research, I leverage insights from Cognitive Science to enhance human-AI collaboration." duration=3s >}} {{< animate fadeIn "To this end, I'm exploring the application of model-based reinforcement learning, Bayesian computational models, and ideas from causal reasoning research." duration=3s >}}
...
<button class="button-link2" onclick="copySignalHandle()" style="text-decoration: none; color: white; background-color: #222; padding: 10px 20px; border-radius: 5px; display: inline-block; font-size: 1.2rem; text-align: center;">
    <i class="bi bi-signal"></i> <span class="handle-text"><span class="default">Signal</span><span class="hover">L11.98</span></span>
</button>
